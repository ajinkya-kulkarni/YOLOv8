...
class Dataset(torch.utils.data.Dataset):
    ...
    """
    def __init__(self, config:str, batch_size:int=4, mode:str='train', img_size:Tuple[int,int]=(512, 512)):
        super().__init__()
    ...
    def load_image(self, idx):
        ...
        image = cv2.cvtColor(cv2.imread(im_file, cv2.IMREAD_UNCHANGED), cv2.COLOR_BGR2RGB)
        ...
        image = torch.from_numpy(image).float() / 65535.0
